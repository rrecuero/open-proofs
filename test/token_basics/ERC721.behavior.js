...
const ERC721Receiver = artifacts.require('Badges.sol');
...
function shouldBehaveLikeERC721 (
  ...
  describe('like an ERC721', function () {
    beforeEach(async function () {
      await this.token.mintWithTokenURI(owner, firstTokenId, '', { from: minter });
      await this.token.mintWithTokenURI(owner, secondTokenId, '', { from: minter });
        ...
        const shouldTransferSafely = function (transferFun, data) {
          ...
          describe('to a valid receiver contract', function () {
            ...
            it('should call onERC721Received from approved', async function () {
              ...
              result.receipt.logs.length.should.be.equal(2);
              console.log('result.receipt.logs', result.receipt.logs);
